...
public enum Problem {
    ...
    UNKNOWN_MC_VERSION(true, "Could not parse Minecraft version."),
    ...
    BAD_MAPPINGS_VERSION(false, "Server internals seem to have changed since this build was created."),
