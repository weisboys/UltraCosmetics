...
public class ParticleEffectType extends CosmeticParticleType<ParticleEffect> {
    ...
    public static void register(ServerVersion version) {
        ...
        new ParticleEffectType("BloodHelix", 1, Particles.DUST, XMaterial.REDSTONE, ParticleEffectBloodHelix.class, true);
        ...
        new ParticleEffectType("GreenSparks", 1, Particles.HAPPY_VILLAGER, XMaterial.EMERALD, ParticleEffectGreenSparks.class, false);
        ...
        new ParticleEffectType("Enchanted", 1, Particles.ENCHANT, XMaterial.BOOK, ParticleEffectEnchanted.class, true);
        new ParticleEffectType("Inferno", 1, Particles.FLAME, XMaterial.NETHER_WART, ParticleEffectInferno.class, true);
        new ParticleEffectType("AngelWings", 2, Particles.DUST, XMaterial.FEATHER, ParticleEffectAngelWings.class, true);
        new ParticleEffectType("RainbowWings", 2, Particles.DUST, XMaterial.YELLOW_DYE, ParticleEffectRainbowWings.class, true);
        new ParticleEffectType("SuperHero", 2, Particles.DUST, XMaterial.GLOWSTONE_DUST, ParticleEffectSuperHero.class, true);
        new ParticleEffectType("SantaHat", 2, Particles.DUST, XMaterial.BEACON, ParticleEffectSantaHat.class, true);
        ...
        new ParticleEffectType("RainCloud", 1, Particles.DRIPPING_WATER, XMaterial.LAPIS_LAZULI, ParticleEffectRainCloud.class, true);
        new ParticleEffectType("CrushedCandyCane", 1, Particles.ITEM, XMaterial.WHITE_DYE, ParticleEffectCrushedCandyCane.class, true);
        new ParticleEffectType("InLove", 1, Particles.HEART, XMaterial.RED_DYE, ParticleEffectInLove.class, true);
        new ParticleEffectType("MagicalRods", 3, Particles.DUST, XMaterial.BLAZE_ROD, ParticleEffectMagicalRods.class, true);
        new ParticleEffectType("FireWaves", 4, Particles.FLAME, XMaterial.GOLD_NUGGET, ParticleEffectFireWaves.class, true);
        new ParticleEffectType("CursedHalo", 2, Particles.WITCH, XMaterial.PURPLE_DYE, ParticleEffectCursedHalo.class, false);
        new ParticleEffectType("VolcanicHalo", 2, Particles.FLAME, XMaterial.MAGMA_CREAM, ParticleEffectHalo.class, false);
        new ParticleEffectType("CursedFootprints", 1, Particles.WITCH, XMaterial.JACK_O_LANTERN, ParticleEffectFootprints.class, false);
        new ParticleEffectType("SpringFootprints", 1, Particles.HAPPY_VILLAGER, XMaterial.POPPY, ParticleEffectFootprints.class, false);
        new ParticleEffectType("ShadowFootprints", 2, Particles.LARGE_SMOKE, XMaterial.BLACK_WOOL, ParticleEffectFootprints.class, false);
